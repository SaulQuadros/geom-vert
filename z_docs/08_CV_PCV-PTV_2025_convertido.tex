...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{figuras/Fig_05_estaca_exemplo.png}
\caption{Perfil longitudinal da concordância vertical assimétrica do exemplo.
O inset amplia a região da estaca 7+00,00 ($x = 20$ m), mostrando a cota na
reta tangente $Z_{\mathrm{tang}}(20)$, a cota do greide $Z(20)$ e a flecha
local $f(20) = 0{,}060$ m entre elas.}
\end{figure}
